...
public class FrmEnter_Add extends JDialog implements ActionListener
{
	...
	public FrmEnter_Add(FrmEnterManager frmEnterManager, String s, boolean b)
	{
		...
		labelNote.setBounds(30, 143, 219, 14);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		/*else if (e.getSource() == this.cmbHouse)
		{
			...
			for (int i = 0; i < houseList.size(); i++)
			{
				cmbGoods.addItem(houseList.get(i).getHouseName());
			}
		}*/
		/*else if (e.getSource() == this.cmbGoods)
		{
			cmbGoods.removeAllItems();
			goodsList = (new GoodsManager()).loadAllGoods();
			cmbHouse.addItem("");
		...
		else if (e.getSource() == this.cmbSupplier)
		{
			cmbSupplier.removeAllItems();
			supplierList = (new SupplierManager()).loadAllSupplier();
			cmbHouse.addItem("");
			for (int i = 0; i < supplierList.size(); i++)
			{
				cmbGoods.addItem(supplierList.get(i).getSupplierName());
			}
		}*/
	}
}
