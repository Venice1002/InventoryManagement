...
public class FrmDestoryManager extends JDialog implements ActionListener
{
	...
	public FrmDestoryManager(Frame f, String s, boolean b)
	{
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			FrmDestory_Check dlg = new FrmDestory_Check(this, "报废单盘查", true);
			dlg.setVisible(true);
		}
